  ...
  return [
    {
      ...
      description: [
        t(
          'Trades are settled in WKCS, which is a wrapped version of BNB used on BNB Smart Chain. That means that when you sell an item, WBNB is sent to your wallet instead of BNB.',
        ),
    ...
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.orkswap-frontend.vercel.app/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
